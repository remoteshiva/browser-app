...
const Login = ({loginUser}: Props) => {
  return (
    <Wrapper>
      ...
      <DarkButton className='w-full' onClick={() => loginUser('ronb', 'password')}>Login</DarkButton>
      <VerticalSpace height={20}/>
      <LightButton className='w-full' onClick={() => loginUser('ronb', 'password')}>Login with Google</LightButton>
      <VerticalSpace height={20}/>
